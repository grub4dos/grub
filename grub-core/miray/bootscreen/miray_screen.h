...
struct miray_screen
{
   ...
   void (*warning) (struct miray_screen *, const char * message);
...
static inline void miray_screen_warning(const char * warning)
{
   if (_miray_screen != 0 && _miray_screen->warning != 0)
      (_miray_screen->warning) (_miray_screen, warning);
}
