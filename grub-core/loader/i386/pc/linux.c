...
{
  cmd_linux =
    grub_register_command_lockdown ("linux", grub_cmd_linux_common,
				    0, N_("Load Linux."));
  cmd_linux16 =
    grub_register_command_lockdown ("linux16", grub_cmd_linux,
				    0, N_("Load Linux."));
  cmd_initrd =
    grub_register_command_lockdown ("initrd", grub_cmd_initrd_common,
				    0, N_("Load initrd."));
  cmd_initrd16 =
    grub_register_command_lockdown ("initrd16", grub_cmd_initrd,
				    0, N_("Load initrd."));
  my_mod = mod;
}
